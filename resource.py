...
_name2id[_rt_ASIS] = 64
_name2id[_lt_ASIS] = 63
_name2id[_rt_hip_center] = 66
_name2id[_lt_hip_center] = 65
...
_strcture_name_list = copy.deepcopy(_strcture_name_list_without_skin)
_strcture_name_list.append(_skin)
